...
If review finds required changes, do not treat the review as complete. Produce an actionable report with exact findings, expected fixes, relevant files/tests, and risk level. The parent assigns fixes and invokes a fresh focused review.
